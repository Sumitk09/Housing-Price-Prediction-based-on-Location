...
lin_rmses = -cross_val_score(lin_regression, housing_prepared, housing_train_label, scoring="neg_root_mean_squared_error", cv=10)
...
dec_rmses = -cross_val_score(dec_regression, housing_prepared, housing_train_label, scoring="neg_root_mean_squared_error", cv=10)
...
Random_Forest_rmses = -cross_val_score(Random_Forest_regression, housing_prepared, housing_train_label, scoring="neg_root_mean_squared_error", cv=10)
